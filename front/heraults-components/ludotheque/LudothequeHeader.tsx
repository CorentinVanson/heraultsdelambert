...
const LudothequeHeader = () => {
  return (
      <section className="relative py-10 gap-16 bg-tertiary-700 min-h-[500px] max-h-[50vh] flex items-center overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-between max-w-4xl bg-primary-50 min-[900px]:rounded-e-3xl p-16 z-10">
            <div className="">
