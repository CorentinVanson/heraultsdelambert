        ...
        <DrawerContent className="bg-primary-50">
          ...
          <DrawerBody>
            <div>
                ...
                <Link className="text-primary-700 hover:text-secondary-500 transition-colors duration-300 py-4 text-2xl" onPress={() => {navigation.navigate('Convention'); setShowDrawer(false);}}>Convention</Link>
